(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var IsDonePipe = /** @class */ (function () {
                function IsDonePipe() {
                }
                IsDonePipe.prototype.transform = function (todoList, askedType) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Todo = /** @class */ (function () {
                function Todo(id, title, stateOfDo, description) {
                    this.id = id;
                    this.title = title;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TodoDetailComponent = /** @class */ (function () {
                function TodoDetailComponent(store, route, router) {
                    this.store = store;
                    this.route = route;
                    this.router = router;
                ...
                TodoDetailComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (params) {
                        ...
                        _this.id = id;
                        return _this.store.select('todoList');
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (todoState) {
                        return todoState.todos.find(function (todo, index) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TodoEditComponent = /** @class */ (function () {
                function TodoEditComponent(store, router, route) {
                    this.store = store;
                    this.router = router;
                    this.route = route;
                }
                ...
                TodoEditComponent.prototype.initForm = function () {
                    var _this = this;
                    var id;
                    var title = '';
                    var descritpion = '';
                    var stateOfDo = false;
                    this.store.select('todoList').subscribe(function (todosState) {
                        id = todosState.todos.reduce(function (max, todo) { return (todo.id > max ? todo.id : max); }, todosState.todos[0].id) + 1;
                        _this.todoForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ADD_TODO_START = 'ADD_TODO_START';
            var ADD_TODO = 'ADD_TODO';
            var ADD_TODOS = 'ADD_TODOS';
            var UPDATE_STATE_OF_DO = 'UPDATE_STATE_OF_DO';
            ...
            var AddTodoStart = /** @class */ (function () {
                function AddTodoStart(payload) {
                    this.payload = payload;
            ...
            var UpdateStateOfDo = /** @class */ (function () {
                function UpdateStateOfDo(payload) {
                    this.payload = payload;
                    this.type = UPDATE_STATE_OF_DO;
                }
                return UpdateStateOfDo;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TodoEffects = /** @class */ (function () {
                function TodoEffects(actions, todoServ) {
                    var _this = this;
                    this.actions = actions;
                    this.todoServ = todoServ;
                    this.todoCreate = this.actions.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["ofType"])(_todo_list_action__WEBPACK_IMPORTED_MODULE_4__["ADD_TODO_START"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (TodoData) {
                        return _this.todoServ.createTodo(TodoData.payload)
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (resData) {
            ...
            function todoListReducer(state, action) {
                ...
                switch (action.type) {
                    ...
                    case _todo_list_action__WEBPACK_IMPORTED_MODULE_1__["UPDATE_STATE_OF_DO"]:
                        var todo = state.todos[action.payload.index];
                        todo.stateOfDo = !todo.stateOfDo;
                        var updateTodo = Object.assign({}, todo, action.payload.todo);
                        var updateTodos = state.todos.slice();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TodoListComponent = /** @class */ (function () {
                function TodoListComponent(store, route, router) {
                    this.store = store;
                    this.route = route;
                    this.router = router;
                }
                ...
                TodoListComponent.prototype.onNewTodo = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var TodoStartComponent = /** @class */ (function () {
                function TodoStartComponent() {
                }
                TodoStartComponent.prototype.ngOnInit = function () {
                };
                return TodoStartComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TodoComponent = /** @class */ (function () {
                function TodoComponent(todoServ, store) {
                    this.todoServ = todoServ;
                    this.store = store;
                }
                TodoComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.todoServ.getTodos().subscribe(function (data) {
                        _this.store.dispatch(new _todo_list_store_todo_list_action__WEBPACK_IMPORTED_MODULE_4__["AddTodos"](data));
                    });
                };
